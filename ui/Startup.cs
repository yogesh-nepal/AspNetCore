    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddHttpClient("apiClient",s=>{
                s.BaseAddress= new Uri("https://localhost:6001/api/");
                s.DefaultRequestHeaders.Clear();
                s.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));
            });
            //agi garya jasto garera tana api globalvariable banaunu pardaina ni ani
            //pardaina sabai dependency bata kaam gara ok
            //aba nuget package haru chai kasari install garne
